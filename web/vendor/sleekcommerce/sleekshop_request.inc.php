...
define("LICENCE_USERNAME",getenv("LICENCE_USERNAME"));
define("SERVER","https://".getenv("SHOPNAME").".sleekshop.net/srv/service/");
define("LICENCE_PASSWORD",getenv("LICENCE_PASSWORD"));
